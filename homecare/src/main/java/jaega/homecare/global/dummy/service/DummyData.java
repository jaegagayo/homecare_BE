...
public class DummyData {
    ...
    protected static final String[] DUMMY_ADDRESSES = {
    ...
    protected static final double[] DUMMY_LATITUDES = {
    ...
    protected static final double[] DUMMY_LONGITUDES = {
    ...
    protected static final String[] DUMMY_INTRODUCTIONS = {
    ...
    // 예시: 순천 외 주소 선택 함수
    protected static String pickNonSuncheonAddress(int index) {
